    ...
    <section className="bg-white py-16">
      <div className=" container mx-auto px-4">
        ...
        <div className="relative">
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
              {services.map((item, index) => (
                ...
                >
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 spcae-y-4 h-full flex flex-col">
                    <div className=" flex-1 flex items-start justify-between">
                      <div className="flex gap-4">
                        <span className="text-3xl">{item.icon}</span>
                        <div>
                          <h3 className="font-bold text-x1 my-1">
                            {item.title}
                          </h3>
                    ...
                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                      ...
                      <a
                        ...
                        hover:bg-red-500 px-4 py-1 rounded-md duration-300"
                      >
          ...
          <button
            className="bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute right-3 -translate-y-1/2
          translate-x-1/2 top-1/2 z-10"
            onClick={scrollNext}
          >
